...
question1.visible=false;
 ...
 GroundGroup.add(g6)
   ...
   GroundGroup.add(g10)
    ...
    start2=createSprite(windowWidth-60,580,100,20)
...
ghost1.bounceOff(edges);
  if(gameState == 'Level2'){
    ...
    if(gameState == 'level2' && heart3.visible==false){
      bgIMG=bgreset
      level2Group.setVisibleEach(false);
      wallsGroup.setVisibleEach(false);
    }}
